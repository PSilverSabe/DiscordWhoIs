...
public abstract class RepositoryBase<TContext, TLogger>(IDbContextFactory<TContext> dbContextFactory, ILogger<TLogger> logger)
    where TContext : DbContext
{
    protected readonly IDbContextFactory<TContext> _dbContextFactory = dbContextFactory;
    protected readonly ILogger<TLogger> _logger = logger;
